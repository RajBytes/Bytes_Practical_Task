...
import com.bytes.app.BuildConfig
import com.bytes.app.network.ApiInterface
import com.bytes.app.network.HttpHandleIntercept
...
class NetworkModule {
    ...
    /**
     * This method is used to create and provide the api interface to make an api call.
     */
    @Provides
    @ViewModelScoped
    ...
    /**
     * THis method is used to Intercept the Each Api call.
     */
    @Provides
